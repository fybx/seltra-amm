"""
SeltraPoolCore Deployment Configuration
Handles deployment of the refactored minimal AMM core contract
"""
...
def deploy(
    ...
    """
    Deploy the refactored SeltraPoolCore contract.
    ...
    """
    try:
        logger.info("🚀 Deploying SeltraPoolCore contract...")
        ...
        logger.info(f"✅ SeltraPoolCore deployed successfully!")
        ...
        logger.error(f"❌ Failed to deploy SeltraPoolCore: {e}")
        raise


def verify_deployment(app_id: int, deployer_address: str) -> bool:
    """
    Verify that the SeltraPoolCore was deployed correctly.
    ...
    try:
        ...
        logger.info(f"✅ SeltraPoolCore deployment verification passed")
        logger.info(f"   App ID: {app_id}")
