...
const ALGOD_ADDRESS =
  process.env.REACT_APP_ALGOD_ADDRESS || "http://localhost:4001";
const ALGOD_TOKEN =
  process.env.REACT_APP_ALGOD_TOKEN ||
  "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
const INDEXER_ADDRESS =
  process.env.REACT_APP_INDEXER_ADDRESS || "http://localhost:8980";
const SIMULATOR_ADDRESS =
  process.env.REACT_APP_SIMULATOR_ADDRESS || "http://localhost:8001";
